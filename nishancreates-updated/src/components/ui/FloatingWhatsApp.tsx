...
export default function FloatingWhatsApp() {
  const { contactConfig } = useGlobalConfig();
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-bg-card border border-border rounded-card px-4 py-2 mr-1"
          >
            <p className="text-text-primary text-sm font-mono whitespace-nowrap">
